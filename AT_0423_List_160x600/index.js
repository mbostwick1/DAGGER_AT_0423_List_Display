...
p.nominalBounds = new cjs.Rectangle(0,0,320,579);
...
}).prototype = getMCSymbolPrototype(lib.text4_2_1, new cjs.Rectangle(0,0,160,600), null);
...
}).prototype = getMCSymbolPrototype(lib.text4_1_1, new cjs.Rectangle(0,0,160,600), null);
...
}).prototype = getMCSymbolPrototype(lib.orange_1, new cjs.Rectangle(0,0,160,600), null);
...
}).prototype = getMCSymbolPrototype(lib.back_1, new cjs.Rectangle(0,0,160,289.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [0,74,153,225,257,344];
	// timeline functions:
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(74).call(this.frame_74).wait(79).call(this.frame_153).wait(72).call(this.frame_225).wait(32).call(this.frame_257).wait(87).call(this.frame_344).wait(1));
	...
	this.instance_1.setTransform(424.45,389.4,1.0778,1.0778,0,0,180,195.1,63.1);
	this.instance_1._off = true;

	this.car = new lib.car_SIDEIn_mc();
	this.car.name = "car";
	this.car.setTransform(-297.15,389.4,1.0778,1.0778,0,0,180,195,63.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},75).to({state:[{t:this.car}]},78).wait(192));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(75).to({_off:false},0).to({_off:true,regX:195,x:-297.15},78,cjs.Ease.cubicIn).wait(192));

	// car
	this.car_1 = new lib.car_SIDEIn_mc();
	this.car_1.name = "car_1";
	this.car_1.setTransform(-238.8,145.6,1.0778,1.0778,0,0,0,195,63.1);
	this.car_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.car_1).wait(1).to({_off:false},0).to({regX:195.1,x:434.45,y:145.4},73,cjs.Ease.cubicIn).wait(271));

	// cta
	this.instance_2 = new lib.cta_1();
	this.instance_2.setTransform(83.05,463.05,0.3247,0.3247,0,0,0,83,463.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({regY:463,scaleX:1,scaleY:1,x:83,y:463,alpha:1},46,cjs.Ease.elasticOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(271).to({_off:false},0).to({y:45,alpha:1},33,cjs.Ease.cubicOut).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(258).to({_off:false},0).to({alpha:1},46,cjs.Ease.cubicOut).wait(41));

	// text42
	this.instance_5 = new lib.text4_2_1();
	this.instance_5.setTransform(79.05,368,1,1.0646,0,19.8955,0,80.5,368.6);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(245).to({_off:false},0).to({regX:79,regY:368,scaleY:1,skewX:0,x:79,alpha:1},12).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(154).to({_off:false},0).to({y:22},59,cjs.Ease.backIn).to({y:45},11,cjs.Ease.quadOut).wait(2).to({regX:79,regY:368,x:79,y:368},0).to({regX:80.4,regY:368.5,scaleY:1.0654,skewX:19.9875,x:79.05,y:367.95},19).to({regX:79,regY:368,scaleY:1,skewX:0,x:79,y:368,alpha:0},12).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(154).to({_off:false},0).to({y:22},59,cjs.Ease.backIn).to({y:45},11,cjs.Ease.quadOut).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(139).to({_off:false},0).wait(45).to({alpha:0},28,cjs.Ease.cubicOut).wait(133));
	...
	this.instance_10.setTransform(364,35,1,1,0,0,0,364,45);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1).to({_off:false},0).to({y:45,alpha:1},26).to({_off:true},112).wait(206));

	// orange
	this.instance_11 = new lib.orange_1();
	this.instance_11.setTransform(364,329,1,1,0,0,0,364,45);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(154).to({y:45},58,cjs.Ease.quartIn).wait(133));
	...
	// OG_back
	this.instance_13 = new lib.orange_1();
	this.instance_13.setTransform(364,45,1,1,0,0,0,364,45);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(345));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-426.8,183.9,1070.8,1078.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1681510292049", id:"back"},
		{src:"images/blue.jpg?1681510292049", id:"blue"},
		{src:"images/car.png?1681510292049", id:"car"},
		{src:"images/cta.png?1681510292049", id:"cta"},
		{src:"images/logo.png?1681510292049", id:"logo"},
		{src:"images/orange.png?1681510292049", id:"orange"},
		{src:"images/text1.png?1681510292049", id:"text1"},
		{src:"images/text2.png?1681510292049", id:"text2"},
		{src:"images/text3.png?1681510292049", id:"text3"},
		{src:"images/text4_1.png?1681510292049", id:"text4_1"},
		{src:"images/text4_2.png?1681510292049", id:"text4_2"},
		{src:"images/text5.png?1681510292049", id:"text5"},
		{src:"images/wheel.png?1681510292049", id:"wheel"}
	],
	preloads: []
};
